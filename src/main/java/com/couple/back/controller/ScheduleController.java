...
public class ScheduleController {
    ...
    public ResponseEntity<ApiResponse<List<Calendar>>> getCalender(@PathVariable Long userId) {
        try {
            List<Calendar> result = scheduleService.getCalender(userId);
            if(result == null) {
    ...
    public ResponseEntity<ApiResponse<String>> updateTodo(@PathVariable String id)  {
        try {
